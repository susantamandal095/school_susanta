...
<center>  
        ...
        <table class="table table-striped table-condensed    
          ...
          $i=1; foreach ($files as $file): ?>
            ...
            <td><?php echo $i; ?></td>
              ...
              <td>
                <form action="notice_table.php" method="post">
    ...
    echo "</br>";     
        ...
        if($page>=2){   
            echo "<a href='notice_table.php?page=".($page-1)."'>  Prev </a>";   
        }       
                   
        for ($i=1; $i<=$total_pages; $i++) {   
          if ($i == $page) {   
              $pagLink .= "<a class = 'active' href='notice_table.php?page="  
                                                .$i."'>".$i." </a>";   
          }               
          else  {   
              $pagLink .= "<a href='notice_table.php?page=".$i."'>   
                                                ".$i." </a>";     
          }   
        };     
        echo $pagLink;   
        ...
        if($page<$total_pages){   
            echo "<a href='notice_table.php?page=".($page+1)."'>  Next </a>";   
        }   
  ...
  <script>   
    ...
    {   
        ...
        window.location.href = 'notice_table.php?page='+page;
    }   
  </script> 
