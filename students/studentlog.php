<?php
    ...
    if (isset($_POST['email'])) {
        ...
        if ($rows == 1) {
            ...
            echo "<script type='text/javascript'> document.location ='studentlog.php'; </script>";
        }
    } else {
?>
<!doctype html>
  ...
  <div class="demo form-bg">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-offset-4 col-md-4 col-sm-offset-3 col-sm-6">
                ...
                <div class="form-icon"><i class="fa fa-user-circle"></i></div>
                    <h3 class="title">Students Login</h3>
        ...
        <div class="form-group">
            ...
            <p class="link">Go to home <a href="../index.php">Home</a></p>
  </form>
            </div>
        </div>
    </div>
